...
const LAYER_STANDARD = Dict(
    1 => OpenStreetMapXPlot.Style("0x7BB6EF", 4), # Soft blue
    2 => OpenStreetMapXPlot.Style("0x66C266", 3), # Soft green
    3 => OpenStreetMapXPlot.Style("0xE68080", 3), # Soft red
    4 => OpenStreetMapXPlot.Style("0xFF9900", 3), # Soft orange
    5 => OpenStreetMapXPlot.Style("0xDADA47", 3), # Dark yellow
    6 => OpenStreetMapXPlot.Style("0x999999", 2), # Dark gray
    7 => OpenStreetMapXPlot.Style("0xE0E0E0", 2), # Light gray
    8 => OpenStreetMapXPlot.Style("0x999999", 1)) # Dark gray
